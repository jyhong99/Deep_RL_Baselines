...
class Trainer:
    ...
    def train(self, 
        ...
        end_log = {
            ...
            'global_mean_len': global_stats["mean_len"] / self.eval_intervals,
            'global_mean_ret': global_stats["mean_ret"] / self.eval_intervals,           
        }
        ...
        print(f'GLOBAL MEAN EPISODE LENGTH  | {round(global_stats["mean_len"] / eval_intervals, 4)}')
        print(f'GLOBAL MEAN EPISODE RETURN  | {round(global_stats["mean_ret"] / eval_intervals, 4)}')
        print(f'============================+=====================================')
...
class DistributedTrainer:
    ...
    def train(self, 
            ...
            policy_type, show_stats, show_graphs
            ):
...
class Runner:
    ...
    def run(self, buffer, runner_iters):
        ...
        while timesteps < runner_iters:
            ...
            timesteps += 1
            action = self.runner.act(self.state)
